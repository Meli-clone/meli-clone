                ...
                <div className="details_column2">
                    <div>
                        <div className="details_conditionContainer">
                            ...
                            {(product.sold_quantity === 0) ? null : <p>{product.sold_quantity} vendidos</p>}
                        </div>
                        <h2 className="details_title">{product.title}</h2>
                        <h3 className="details_price">$ {product.price}</h3>
                        <p className="details_cuotas">en 12X $ {(product.price / 12).toFixed(2)}</p>
                    ...
                    <div className="details_buyContainer">
                        <div className="details_buy_infoContainer">
                            ...
                            <div>
                                ...
                                <p className="details_info">Comprando dentro de las próximas 6hs</p>
                        ...
                        <div className="details_buy_infoContainer">
                            ...
                            <div>
                                ...
                                <p className="details_info">Tenés 30 días desde que lo recibís</p>
                                <a className="details_link">Conocer más</a>
                            </div>
                        </div>
                        <div className="details_buy_buttonsContainer">
                            <h4 className="details_stock">{titleStock}</h4>
                            {(product.available_quantity >= 1) ? <p className="details_available">Puedes comprar hasta {product.available_quantity} {(product.available_quantity === 1) ? <span>unidad</span> : <span>unidades</span>}</p> : null}
                            {(product.buying_mode === "buy_it_now") && <button className="details_buttonBuy">Comprar ahora</button>}
                            <button className="details_buttonCart">Agregar al carrito</button>
                        </div>
                        <div className="details_buy_infoContainer">
                            <BiCheckShield className="details_iconsGray"/>
                            <div>
                                <p className="details_blueTitle">Compra protegida.</p>
                                <p className="details_infoGray">Recibí el producto que esperabas o te devolvemos tu dinero.</p>
                            </div>
                        </div>
                        <div className="details_buy_infoContainer">
